...
https://docs.akeneo.com/2.1/install_pim/manual/system_requirements/system_requirements.html
...
To install Akeneo PIM for a PIM project or for evaluation, please follow: https://docs.akeneo.com/2.1/install_pim/manual/installation_ce_archive.html
...
```
    $ php composer.phar create-project --prefer-dist akeneo/pim-community-standard ./pim-project "2.1.*@stable"
```

After that, follow the instructions here: https://docs.akeneo.com/2.1/install_pim/installation_ce_archive.html

Upgrade instructions
--------------------

To upgrade Akeneo PIM to a newer version, please follow:
https://docs.akeneo.com/2.1/migrate_pim/index.html
